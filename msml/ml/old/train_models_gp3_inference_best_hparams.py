...
if __name__ == '__main__':
    ...
    parser.add_argument("--min_mz_parent", type=int, default=0)
    parser.add_argument("--max_mz_parent", type=int, default=10000)
    ...
    args.exp_name = f'results/multi/mz{args.mz}/rt{args.rt}/' \
        ...
        f'gkf0_ovr{args.ovr}_{cropings}_{"_".join(concs)}/xgboost_best_hparams/remove_bad_samples{args.remove_bad_samples}/saved_models/'
