...
class Train:
    ...
    def train(self, h_params):
        ...
        # TODO Replace all these lists for a dict of dicts of lists 
        scores_valid = []
        scores_train = []
        scores_test = []
        scores_posurines = []
        ...
        # if len(all_data['inputs']['urinespositives']) > 0 and scaler_name in ['none']:
